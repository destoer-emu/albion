...
{   
    ...
    {
        const auto OP = (i >> (11-8)) & 0x3;
        const auto RD = (i >> (8-8)) & 0x7;
    ...
    {
        printf("&Cpu::thumb_alu,\n");
    }

    // THUMB.5: Hi register operations/branch exchange
    else if(((i >> 2) & 0b111111) == 0b010001)
    {
        const auto OP = (i >> (8-8)) & 0x3;
    ...
    {
        const auto RD = (i >> (8-8)) & 0x7;
        const bool IS_PC = !is_set(i,11-8);
    ...
    //THUMB.14: push/pop registers
        ...
        && ((i >> 1) & 0b11) == 0b10)
    {
        const bool POP = is_set(i,11-8);
        const bool IS_LR = is_set(i,8-8);
    ...
    {
        const bool FIRST = !is_set(i,11-8);
